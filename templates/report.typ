...
#let conf(
  ...
  show heading.where(level: 1): it => {
    ...
    block(
      ...
      #grid(
        columns: (auto, 1fr),
        column-gutter: 12pt,
        text(24pt, weight: "bold", fill: rgb("#4b5563"))[#counter(heading).display()],
  ...
  if title != none and title != "" [
    ...
    page()[
      ...
      // Note: Actual TOC would be generated by outline() in real use
      #text(10pt, style: "italic", fill: rgb("#6b7280"))[
        Table of contents will be automatically generated based on document headings.
      ]
    ]
  ]
